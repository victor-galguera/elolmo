jQuery(document).ready(function($) {
    var map_latitude = $('#map').attr('data-latitude');
    var map_longitude = $('#map').attr('data-longitude');
